    ...
    function displayInfo(jsonObject) {
        ...
        function iterateArray(jsonObject){
            ...
            margaritaTitle.addEventListener('click', () => {
                ...
                jsonObject.strIngredient1 === null ? ingredient1.innerHTML = ``:ingredient1.textContent = jsonObject.strMeasure1 + " " + jsonObject.strIngredient1
                jsonObject.strIngredient2 === null ? ingredient2.innerHTML = ``:ingredient2.textContent = jsonObject.strMeasure2 + " " + jsonObject.strIngredient2
                jsonObject.strIngredient3 === null ? ingredient3.innerHTML = ``:ingredient3.textContent = jsonObject.strMeasure3 + " " + jsonObject.strIngredient3
                jsonObject.strIngredient4 === null ? ingredient4.innerHTML = ``:ingredient4.textContent = jsonObject.strMeasure4 + " " + jsonObject.strIngredient4
        ...
        document.querySelector("#randomGenerator").addEventListener("click", () => {
            ...
            function randomDisplay (jsonObject) {
                ...
                drinkListRandom.strIngredient1 === null ? ingredient1.innerHTML = ``:ingredient1.textContent = drinkListRandom.strMeasure1 + " " + drinkListRandom.strIngredient1
                drinkListRandom.strIngredient2 === null ? ingredient2.innerHTML = ``:ingredient2.textContent = drinkListRandom.strMeasure2 + " " + drinkListRandom.strIngredient2
                drinkListRandom.strIngredient3 === null ? ingredient3.innerHTML = ``:ingredient3.textContent = drinkListRandom.strMeasure3 + " " + drinkListRandom.strIngredient3
                drinkListRandom.strIngredient4 === null ? ingredient4.innerHTML = ``:ingredient4.textContent = drinkListRandom.strMeasure4 + " " + drinkListRandom.strIngredient4
